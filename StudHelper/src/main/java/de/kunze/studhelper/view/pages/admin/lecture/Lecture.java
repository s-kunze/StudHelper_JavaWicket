...
public class Lecture extends AdminBasePage {
	...
	private void initComponents() {
		...
		this.dataView = new DataView<LectureTransfer>("lectureTable", new ListDataProvider<LectureTransfer>(list)) {
			...
			public void populateItem(final Item<LectureTransfer> item) {
				...
				}.add(new Image("imageAddLectureUser", new SharedResourceReference(AdminBasePage.class, "../../gfx/add.png"))));
				...
				}.add(new Image("imageEditLecture", new SharedResourceReference(AdminBasePage.class, "../../gfx/edit.png"))));
				...
				}.add(new Image("imageDeleteLecture", new SharedResourceReference(AdminBasePage.class, "../../gfx/delete.png"))));
			}
		};
		...
		this.ddc = new DropDownChoice<ModulTransfer>("ddcLecture", new PropertyModel(this, "mt"), modules,
