package de.kunze.studhelper.view.pages.admin.part;
...
import de.kunze.studhelper.view.pages.admin.modul.CreateModul;
...
public class Part extends AdminBasePage {
	...
	private void initComponents() {
		...
		this.dataView = new DataView<PartTransfer>("partTable", new ListDataProvider<PartTransfer>(list)) {
			...
			public void populateItem(final Item<PartTransfer> item) {
				...
				item.add(new AjaxLink<Void>("addModul") {

					private static final long serialVersionUID = 1L;

					@Override
					public void onClick(AjaxRequestTarget target) {
						getModal().setContent(new CreateModul(getModal().getContentId(), part, Part.this));
				...
				}.add(new Image("imageAddModul", new SharedResourceReference(AdminBasePage.class, "../../gfx/add.png"))));
				...
				}.add(new Image("imageEditPart", new SharedResourceReference(AdminBasePage.class, "../../gfx/edit.png"))));
				item.add(new AjaxLink<Void>("deletePart") {
					...
					public void onClick(AjaxRequestTarget target) {
						...
						getModal().setTitle("Bereich löschen");
						getModal().setInitialHeight(150);
						getModal().setInitialWidth(400);
						getModal().show(target);
					}

				}.add(new Image("imageDeletePart", new SharedResourceReference(AdminBasePage.class, "../../gfx/delete.png"))));
			}
		};
		...
		this.ddc = new DropDownChoice<DegreeCourseTransfer>("ddcPart", new PropertyModel(this, "dt"), degreeCourses,
